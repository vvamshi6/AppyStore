// var app=angular.module("appyStore");
// app.service("contentService",function($http,$q){
//   var factory = {};
//   var deffered=$q.defer();
//   //  $q.list=$stateParams.pid;
//   // console.log($q.list);
//   $http.get('http://beta.appystore.in/appy_app/appyApi_handler.php?method=getContentList&content_type=videos&limit=45&offset=0&catid=175&pcatid=174&age=1.5&incl_age=5',
//   {headers:{'X_APPY_USERID':'290903782','X_APPY_IMEI': '353368070301951','X_APPY_PCP_ID':'999',
//   'X_APPY_CAMPAIGN_ID': '8700441600','X_APPY_APP_TYPE': 'lite','X_APPY_TTR': '10800000' ,
//   'X_APPY_UTYPE': 'O','X_APPY_MSISDN': '0','X_APPY_IS_NEW_USER': 'N','X_APPY_API_KEY':'gh610rt23eqwpll',
...
.factory('CategoryService', function($http,$q) {
            ...
            factory.getData = function(catid, pcatid) {
              ...
              var url = 'http://beta.appystore.in/appy_app/appyApi_handler.php?method=getContentList&content_type=videos&limit=10&offset=0&catid='+pcatid+'&pcatid='+catid+'&age=1.5&incl_age=5'
                console.log(url);
                $http.get(url
